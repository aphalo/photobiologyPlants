...
#'
#' Phytochrome Sigma as a function of wavelength, calculated
#' by interpolatio from data for Type I Phytochrome as compiled
#' by Mancinelli (1994).
#'
#' @usage Phy_Sigma(w.length)
...
#'
#' @seealso \code{\link[photobiologyPlants]{Pfr_P_ratio}} and \code{\link[photobiologyPlants]{Pfr_P_ratio_R_FR}}
#' @examples
