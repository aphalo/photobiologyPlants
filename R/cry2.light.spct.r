...
#' from Figure 1.B, curve "irradiated with blue light (450 nm, 50 umol m-2 s-1)
#' during 30 min", in Banerjee et al. (2007).
#'
...
#' @docType data
#' @keywords datasets
#' @format A \code{filter.spct} object with 200 rows and 2 numeric variables,
