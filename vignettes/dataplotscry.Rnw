...
\section{Check of interpolation}
...
data(cry.data)
points(Absorbance ~ w.length, data=CRY2.dark.raw.data, col="black")
points(Absorbance ~ w.length, data=CRY2.light.raw.data, col="blue")
rm(ex7.data)
@
